...
// function to add items to cart by product.id
...
// function to remove items from cart by productId
...
// function to empty cart by saving empty array
userSchema.methods.clearCart = function() {
  this.cart = { items: [] }
  return this.save()
}

// export user info via mongoose as userSchema
